   ...
   return (
      <Fragment>
         ...
         >
            ...
            <path
               d='M8 .5A4.49 4.49 0 003.5 5v1.5h2V5c0-1.385 1.115-2.5 2.5-2.5a2.49 2.49 0 011.756.72l.008.007a1.003 1.003 0 00.695.279 1.003 1.003 0 001.002-1.002 1.003 1.003 0 00-.559-.899C10.12.93 9.12.5 8 .5z'
               opacity='.2'
            ></path>
         </svg>
      </Fragment>
